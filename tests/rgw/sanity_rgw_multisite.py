...
def run(**kw):
    ...
    if git_clone_configs_repo:
        utils.clone_configs_repo(primary_client_node, "/home/cephuser/")
        utils.clone_configs_repo(secondary_client_node, "/home/cephuser/")
        utils.clone_configs_repo(primary_rgw_node, "/home/cephuser/")
        utils.clone_configs_repo(secondary_rgw_node, "/home/cephuser/")

        for i in range(0, len(primary_rgw_nodes)):
            utils.clone_configs_repo(primary_rgw_nodes[i].node, "/home/cephuser/")
        for i in range(0, len(secondary_rgw_nodes)):
            utils.clone_configs_repo(secondary_rgw_nodes[i].node, "/home/cephuser/")
        if archive_cluster_exists:
            utils.clone_configs_repo(archive_rgw_node, "/home/cephuser/")
            utils.clone_configs_repo(archive_client_node, "/home/cephuser/")
        if tertiary_cluster_exists:
            utils.clone_configs_repo(tertiary_rgw_node, "/home/cephuser/")
            utils.clone_configs_repo(tertiary_client_node, "/home/cephuser/")
